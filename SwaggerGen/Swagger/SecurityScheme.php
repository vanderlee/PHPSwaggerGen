...
class SecurityScheme extends AbstractObject
{
    ...
    public function __construct(AbstractObject $parent, $type, $data = null)
    {
        ...
        if (!in_array(strtolower($type), ['basic', 'apikey', 'oauth2'])) {
        ...
        switch ($this->type) {
            ...
            case 'oauth2':
                ...
                if (in_array($flow, ['password', 'application', 'accesscode'])) {
